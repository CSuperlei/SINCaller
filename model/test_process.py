...
def testing(samples_test_data, samples_test_label, model_params=None, hdf5_file=True, hdf5_fliename='/home/cailei/bio_project/nbCNV/train_log/model_checkpoint/model_10.hdf5'):
    m = SCSNVMODEL()
    if model_params:
