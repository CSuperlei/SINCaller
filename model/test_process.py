...
def testing(samples_test_data, test_model=1, model_params=None, save_result=None, generator_params=None, hdf5_file=True, hdf5_fliename='/mnt/sdc/cailei/bio_project/scSNVIndel_data/model_checkpoint/model_checkpointmodel_30.hdf5'):
