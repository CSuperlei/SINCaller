...
def testing(samples_test_data, model_params=None, hdf5_file=True, hdf5_fliename='/home/cailei/bio_project/nbCNV/train_log/model_checkpoint_attention/model_30.hdf5'):
    m = SCSNVMODEL()
    if model_params:
