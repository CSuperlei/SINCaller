...
class SCSNVMODEL:
    def __init__(self, input_shape=(78, ), n_labels=3, n_lstm_outdim=128, word_maxlen=78, em_inputdim=20, em_outdim=15, lstm_layers=2, dense_num=32, drop_out=0.1, lr=0.001, gpus=2):
