...
class SCSNVMODEL:
    def __init__(self, input_shape=(20, ), n_labels=2, n_lstm_outdim=64, word_maxlen=20, em_inputdim=17, em_outdim=17, lstm_layers=2, dense_layers=2, dense_num=64, drop_out=0.3, lr=0.001, gpus=2):
